...
@section('content')
    <div class="container">
        <h1 class="mb-4 text-center">Profil Kasir</h1>
                        ...
                        @if ($data->isNotEmpty())
                            @foreach ($data as $kasir)
                                <div class="text-center mb-3">
                                    <h4 class="mt-2">{{ $kasir->user->name }}</h4>
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        ...
                                        <strong>No Telepon:</strong> <span
                                            class="no-telepon">{{ $kasir->user->phone ?? 'Nomor tidak ditemukan' }}</span>
                                    </li>
                                    <li class="list-group-item">
                                        <i class="fa fa-venus-mars text-success"></i>
                                        <strong>Jenis Kelamin:</strong> {{ $kasir->jenkel }}
                                    </li>
                                    <li class="list-group-item">
                                        <i class="fa fa-map-marker-alt text-danger"></i>
                                        <strong>Alamat:</strong> {{ $kasir->alamat }}
                                    </li>
                                </ul>

                                <!-- Action Buttons -->
                                <div class="d-flex justify-content-center gap-2 mt-3">
                                    <a href="{{ route('kasir.dashboard') }}" class="btn btn-secondary btn-sm">
                                        <i class="fa fa-arrow-left"></i> Kembali
                                    </a>
                                    <a href="{{ route('kasir.editProfile', $kasir->id_kasir) }}"
