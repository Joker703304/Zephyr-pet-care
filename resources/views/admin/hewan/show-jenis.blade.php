            ...
            <tbody>
                @foreach ($jenisHewan as $index => $jenis)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.hewan.edit-jenis', $jenis->id) }}"
                                class="btn btn-warning btn-sm">Edit</a>
                            <form action="{{ route('admin.hewan.delete-jenis', $jenis->id) }}" method="POST"
                                class="d-inline" onsubmit="return confirm('Yakin ingin menghapus jenis hewan ini?')">
                                @csrf
                                @method('DELETE')
