...
<div class="container">
                    ...
                    @if($data->isNotEmpty())
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                ...
                                <strong>No Telepon:</strong> <span class="no-telepon">{{ $pemilik->user->phone ?? 'Nomor tidak ditemukan' }}</span>
                            </li>
                            <li class="list-group-item">
    ...
    <!-- Modal Ubah Password -->
    <!-- Modal Ubah Password dengan OTP -->
                ...
                <div id="step-password-reset" class="d-none">
                    <form id="verify-password-otp-form">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="otp_code_password" name="otp" class="form-control" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-success w-100">
                            <span id="verify-password-loading" class="spinner-border spinner-border-sm d-none"></span>
...
document.getElementById("verify-password-otp-form").addEventListener("submit", function(event) {
    ...
    fetch("{{ route('verifyOtpChangePassword') }}", {
        ...
        body: JSON.stringify({ phone, otp, password: newPassword, password_confirmation: confirmPassword })
    })
    .then(response => response.json())
    .then(data => {
