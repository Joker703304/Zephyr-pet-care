                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="card resep-card mb-3 shadow-sm border-2 hover-shadow d-flex flex-column">
                        <div class="card-body flex-grow-1">
                            <h6 class="card-title">
                                <i class="fas fa-dog"></i> Hewan: <b>{{ $resepGroup->first()->konsultasi->hewan->nama_hewan }}</b>
                            </h6>
                            <p><i class="fas fa-comment-medical"></i> Keluhan: <b>{{ $resepGroup->first()->konsultasi->keluhan }}</b></p>
                            <p><i class="fas fa-notes-medical"></i> Diagnosis: <b>{{ $resepGroup->first()->konsultasi->diagnosis }}</b></p>
                        ...
                        <div class="card-footer d-flex justify-content-between align-items-center">
                            <a href="{{ route('pemilik-hewan.resep_obat.show', $id_konsultasi) }}" class="btn btn-info btn-sm">
