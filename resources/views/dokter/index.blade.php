...
@section('content')
    <div class="container">
        <h1 class="mb-4 text-center">Profil Dokter</h1>
                        ...
                        @if ($data->isNotEmpty())
                            @foreach ($data as $dokter)
                                <div class="text-center mb-3">
                                    <h4 class="mt-2">{{ $dokter->user->name }}</h4>
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        ...
                                        <strong>No Telepon:</strong> <span
                                            class="no-telepon">{{ $dokter->user->phone ?? 'Nomor tidak ditemukan' }}</span>
                                    </li>
                                    <li class="list-group-item">
                                    ...
                                    {{-- <li class="list-group-item">
                                        ...
                                        <strong>Spesialis:</strong> {{ $dokter->spesialis }}
                                    </li> --}}
                                </ul>
                                ...
                                <div class="d-flex justify-content-center gap-2 mt-3">
                                    ...
                                    <a href="{{ route('dokter.editProfile', $dokter->id_dokter) }}"
