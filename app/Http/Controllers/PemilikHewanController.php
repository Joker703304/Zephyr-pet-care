...
class PemilikHewanController extends Controller
{
    ...
    public function update(Request $request, $id_pemilik)
    {
        ...
        $pemilik->update([
            'nama' => $request->input('nama', $pemilik->nama),
            'email' => $request->input('email', $pemilik->email),
            'jenkel' => $request->input('jenkel', $pemilik->jenkel),
            'alamat' => $request->input('alamat', $pemilik->alamat),
            'no_tlp' => $request->input('no_tlp', $pemilik->no_tlp),
        ]);
